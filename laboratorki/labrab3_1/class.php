...
<tr>
<td width=100% height=20% align=center> Лабораторные работы по курсу "Динамические вэб-системы в экономике" <br> Студента группы ПИс-161: Чинкова Павла Евгеньевича <br> Проверил: к.т.н. доц. Назимов А.С. </td>
</table>
...
<td width=100% height=10% align=center> РОССИЙСКИЙ ЭКОНОМИЧЕСКИЙ УНИВЕРСИТЕТ им. Г. В. ПЛЕХАНОВА КЕМЕРОВСКИЙ ИНСТИТУТ (филиал), Кафедра информационных технологий и прикладной математики, 2019 </td>
...
function processorder ($tirequty, $oilqty, $fio, $addres)
{
	?>
	<html>
    <head>
