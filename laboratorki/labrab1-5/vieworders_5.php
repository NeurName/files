...
$services -> SetTitle('Лабораторные работы по курсу "Динамические вэб-системы в экономике"');
$services -> Setnazvanie('Лабораторные работы по курсу "Динамические вэб-системы в экономике" <br> Студента группы ПИс-161: Конева Виктора Владимировича <br> Проверил: Проверил: к.т.н. доц. Назимов А.С.');
